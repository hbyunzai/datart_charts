 ...
 * @LastEditTime: 2022-09-22 16:15:17
 * @FilePath: \custom-chart-plugins\highcharts-3d-donut-piechar.js
 * @Description: 
 * 
...
function HighCharts3dPieChart({ dHelper }) {
    ...
    return {
        ...
        meta: {
            id: 'highcharts-3d-donut-piechart',
            name: '[HIGHCHARTS][3D][DONUTPIECHART]',
            icon: 'chart',
            requirements: [
                {
                    group: null,
